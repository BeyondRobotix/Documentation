...
{% hint style="info" %}
You can follow this tutorial on the [CAN Node](../l431-can-node.md) instead - it builds with the same environment and the code is identical. Check its page for where to wire the MCP9600.
{% endhint %}
